...
//   };
  ...
  const schema = yup.object({
    ...
    paymentModel: yup.number().positive().required(),
    mediaFile: yup.mixed<FileList>().nullable(),
    mediaLink: yup.string().url().nullable(),
  });
...
const RegisterCompany = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-2xl shadow-lg flex flex-col w-full justify-start ">
      <div className="py-2">
