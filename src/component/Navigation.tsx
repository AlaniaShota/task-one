...
const Navigation = () => {
  return (
    <div className="flex flex-row justify-between items-center m-auto p-6">
      ...
      <Link href='/'><h1 className="text-5xl">Sellvi</h1></Link>
...
<Link href='/login'>      <UserIcon href="/login" className="w-10 h-10 border text-black border-gray-400 p-1 rounded-lg" /></Link>
